...
<div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--10-col-tablet mdl-cell--6-col-phone margin">
 ...
 @section('footer_script')
  ...
  $(document).ready(function(){
    $('#user_profile_attributes_image, .image').on('change', function(){
      if (this.files && this.files[0]) {
        file = this.files[0];
        if (file.type.match('image.*')){
          var reader = new FileReader();
          reader.onload = function(e) { 
            $('.account-content-profile-img .img-circle, .account-content-profile-img .img-responsive').attr('src', e.target.result);
          };
